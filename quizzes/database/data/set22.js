...
const set22 = {
    ...
    questions: [
        ...
        { id: "q14", type: "code-fill", prompt: "문자열 앞(왼쪽)의 공백을 제거하는 함수의 이름을 빈칸에 채우세요.", language: "sql", code: "SELECT ( 1 )(' 공백앞뒤두개 ') AS Result;", blanks: [{ index: 1, answer: "LTRIM" }] },
        ...
        { id: "q19", type: "code-fill", prompt: "현재 날짜와 시간을 반환하는 함수의 이름을 채우세요.", language: "sql", code: "SELECT ( 1 )();", blanks: [{ index: 1, answer: "GETDATE" }] },
        ...
        { id: "q30", type: "code-fill", prompt: "날짜 형식을 지정된 포맷 문자열로 변환하는 함수의 이름을 채우세요.", language: "sql", code: "SELECT ( 1 )(GETDATE(), 'dd/MM/yyyy');", blanks: [{ index: 1, answer: "FORMAT" }] }
    ]
};
