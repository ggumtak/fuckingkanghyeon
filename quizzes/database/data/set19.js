...
const set19 = {
    ...
    questions: [
        ...
        { "id": "1-4", "type": "essay", "prompt": "IDENTITY 속성이 설정된 'num' 열에 강제로 값을 입력하고 싶을 때 사용해야 하는 SET 옵션은 무엇인지 설명하세요.", "rubric": ["IDENTITY_INSERT", "ON 설정", "테이블명 명시"], "maxLength": 200 },
        ...
        { "id": "2-4", "type": "essay", "prompt": "실수로 WHERE 절 없이 UPDATE를 실행했을 때, 이를 되돌리기 위해 미리 걸어두었어야 하는 것은 무엇입니까?", "rubric": ["트랜잭션", "TRANSACTION", "BEGIN TRAN", "ROLLBACK 가능"], "maxLength": 200 },
        ...
        { "id": "3-4", "type": "essay", "prompt": "DELETE와 TRUNCATE의 차이점을 'WHERE 절 사용 가능 여부'를 중심으로 설명하세요.", "rubric": ["DELETE는 WHERE 사용 가능", "TRUNCATE는 WHERE 사용 불가", "TRUNCATE는 전체 삭제만 가능"], "maxLength": 200 },
        ...
        { "id": "4-4", "type": "essay", "prompt": "문자열 컬럼인 'name'에 MAX() 함수를 사용했을 때 어떤 결과가 나오는지 설명하세요.", "rubric": ["가나다 순으로 가장 뒤에 있는 값", "사전 순 마지막 값", "문자열 정렬 기준 최댓값"], "maxLength": 200 },
        ...
        { "id": "5-4", "type": "essay", "prompt": "VARCHAR(MAX) 데이터 타입의 특징과 최대 저장 용량을 설명하세요.", "rubric": ["2GB까지 저장 가능", "대용량 텍스트", "TEXT 타입 대체"], "maxLength": 200 },
        ...
        { "id": "6-4", "type": "essay", "prompt": "DECIMAL(p, s)에서 p(precision)와 s(scale)의 의미를 설명하세요.", "rubric": ["p는 전체 자릿수", "s는 소수점 이하 자릿수", "정수부는 p-s 자리"], "maxLength": 200 },
        ...
        { "id": "7-4", "type": "essay", "prompt": "FULL OUTER JOIN의 결과 집합에 대해 설명하세요.", "rubric": ["왼쪽, 오른쪽 테이블의 모든 행 포함", "매칭되지 않는 부분은 NULL", "합집합 개념"], "maxLength": 200 }
    ]
};
