...
const set19 = {
    setId: "set-19",
    questions: [
        { "id": "1-1", "type": "short", "prompt": "다음은 buyTbl에 새로운 구매 기록을 추가하는 구문입니다. (아이디: 'SSK', 제품: '책', 수량: ?) 빈칸에 들어갈 수량 값은?\n\nINSERT INTO buyTbl VALUES (NULL, 'SSK', '책', '서적', 15, (   ));", "acceptableAnswers": ["10"] },
        ...
        { "id": "2-1", "type": "short", "prompt": "userTbl에서 'BBK' 회원의 국번을 '010', 전화번호를 '1234567'로 동시에 변경하는 구문에서 두 SET 절 사이에 들어갈 기호는?\n\nUPDATE userTbl SET mobile1 = '010' (   ) mobile2 = '1234567' WHERE userID = 'BBK';", "acceptableAnswers": [","] },
        ...
        { "id": "3-1", "type": "short", "prompt": "테이블의 모든 행을 빠르게 삭제하고 공간을 해제하는 명령어입니다. (로그를 최소화함)\n\n(   ) TABLE userTbl;", "acceptableAnswers": ["TRUNCATE", "truncate"] },
        ...
        { "id": "4-1", "type": "short", "prompt": "숫자 123.456을 소수점 둘째 자리에서 반올림하여 123.46을 만드는 함수 이름은?\n\nSELECT (   )(123.456, 2);", "acceptableAnswers": ["ROUND", "round"] },
        ...
        { "id": "5-1", "type": "short", "prompt": "0~255 사이의 정수 데이터를 저장하기에 가장 효율적인 데이터 타입은?\n\nage (   )", "acceptableAnswers": ["TINYINT", "tinyint"] },
        ...
        { "id": "6-1", "type": "short", "prompt": "1부터 시작하여 1씩 자동으로 증가하는 컬럼을 정의할 때 사용하는 속성 이름은?\n\nnum INT (   )(1, 1) PRIMARY KEY", "acceptableAnswers": ["IDENTITY", "identity"] },
        ...
        { "id": "7-1", "type": "short", "prompt": "buyTbl을 기준으로 userTbl을 조인하되, 구매 내역이 있는 정보만 모두 출력하는 구문(오른쪽 테이블 기준)에서 빈칸에 들어갈 키워드는?\n\nSELECT * FROM userTbl U (   ) OUTER JOIN buyTbl B ON U.userID = B.userID;", "acceptableAnswers": ["RIGHT", "right"] },
