...
const QUIZ_CONFIG = {
    ...
    modules: [
        ...
        },
        {
            ...
            type: 'v2',
            quizzes: [
                { id: 'set1', title: '세트 1', subtitle: '형변환/수치/문자열 함수', count: 17, icon: '📊', file: 'database-set1.html' },
                { id: 'set2', title: '세트 2', subtitle: '문자열/날짜/MAX 함수', count: 16, icon: '📊', file: 'database-set2.html' },
                { id: 'set3', title: '세트 3', subtitle: '수치/문자열 계산', count: 10, icon: '🧮', file: 'database-set3.html' },
                { id: 'set4', title: '세트 4', subtitle: '날짜/순위/분석 함수', count: 11, icon: '🧮', file: 'database-set4.html' },
                ...
                { id: 'set17', title: '세트 17', subtitle: '시험 연습 5', count: 33, icon: '📝', file: 'database-set17.html' },
